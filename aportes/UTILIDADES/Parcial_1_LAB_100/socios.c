...
void modificarNombre(eSocios socios[], int tamSocios, int indice){
    ...
    char resp;
        ...
        if(resp == 's'){
            ...
            printf("Se ha modificado el nombre exitosamente\n\n");
        }else{
    ...
    char resp;
        ...
        getChar(&resp, "Esta seguro que desea realizar los cambios s/n?: ", "Error: Ingrese s o n: ", 's', 'n');
         ...
         if(resp == 's'){
            ...
            printf("Se ha modificado el apellido exitosamente\n\n");
        }else{
            printf("No se ha hecho ninguna modificacion\n\n");
        }
...
void modificarSexo(eSocios socios[], int tamSocios, int indice){
    ...
    char resp;
        ...
        getChar(&resp, "Esta seguro que desea realizar los cambios s/n?: ", "Error: Ingrese s o n: ", 's', 'n');
         ...
         if(resp == 's'){
            socios[indice].sexo = auxSexo;
            printf("Se ha modificado el sexo exitosamente\n\n");
        }else{
            printf("No se ha hecho ninguna modificacion\n\n");
        }
    ...
    char resp;
      ...
      getChar(&resp, "Esta seguro que desea realizar los cambios s/n?: ", "Error: Ingrese s o n: ", 's', 'n');
         ...
         if(resp == 's'){
            ...
            printf("Se ha modificado el numero de telefono exitosamente\n\n");
        }else{
            printf("No se ha hecho ninguna modificacion\n\n");
        }
}
